      ...
      >
        ...
        <div className={cn('border-t border-border py-3', collapsed ? 'px-2' : 'px-4')}>
          {collapsed ? (
            ...
            <div className="flex h-[50px] items-center justify-center animate-[message-in_0.2s_ease-out]">
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    onClick={() => { void logout() }}
            ...
            // 展开态：头像 + 用户名 + 邮箱 + 登出按钮
            <div className="flex h-[50px] items-center gap-3 animate-[message-in_0.2s_ease-out]">
